    ...
    <section id="contact" className="py-20 bg-background">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center px-4">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 text-foreground animate-fade-in-up">
            Get In Touch
          </h2>
          ...
          <Card className="max-w-2xl mx-auto hover-scale smooth-bg transition-all duration-300 hover:shadow-lg hover:border-primary/20 animate-fade-in-up animate-delay-300">
            <CardHeader>
            ...
            <CardContent className="space-y-4">
              <Button asChild className="w-full glow-on-hover" size="lg">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button variant="outline" asChild className="flex-1 hover-scale" size="lg">
                  <a 
      ...
      <footer className="mt-16 pt-8 border-t border-border animate-fade-in animate-delay-500">
